// 获取数据 https://dart.cn/tutorials/web/fetch-data
...
void _populateFromJson() {
  ...
  favOne.value = favoriteThings[0].toString();
  favTwo.value = favoriteThings[1].toString();
  favThree.value = favoriteThings[2].toString();

  final chocolateRaioButton =
      jsonData['chocolate'] == false ? noLoveForChocolate : loveChocolate;
  chocolateRaioButton.checked = true;
}
